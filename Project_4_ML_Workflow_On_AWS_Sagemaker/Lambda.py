...
ENDPOINT = "image-classification-2025-08-22-14-33-53-583"  # TODO: fill in
...
def lambda_handler(event, context):
    ...
    # Make a prediction by calling the SageMaker endpoint
    response = runtime.invoke_endpoint(
        EndpointName=ENDPOINT,
        ContentType='image/png',  # For this model, the ContentType needs to be "image/png"
        Body=image
    )
